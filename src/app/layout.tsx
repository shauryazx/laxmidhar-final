...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: `${logoUrl}?v=15`, sizes: 'any' },
      { url: `${logoUrl}?v=15`, type: 'image/png' },
    ],
    apple: [
      { url: `${logoUrl}?v=15`, sizes: '180x180', type: 'image/png' },
    ],
  },
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" href={`${logoUrl}?v=15`} type="image/png" sizes="any" />
        <link rel="shortcut icon" href={`${logoUrl}?v=15`} type="image/png" />
        <link rel="apple-touch-icon" href={`${logoUrl}?v=15`} />
      </head>
