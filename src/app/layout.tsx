...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: `${logoUrl}?v=8`, sizes: '32x32', type: 'image/png' },
      { url: `${logoUrl}?v=8`, sizes: '16x16', type: 'image/png' },
    ],
    apple: [
      { url: `${logoUrl}?v=8`, sizes: '180x180', type: 'image/png' },
    ],
  },
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" href={`${logoUrl}?v=8`} type="image/png" />
        <link rel="shortcut icon" href={`${logoUrl}?v=8`} type="image/png" />
        <link rel="apple-touch-icon" href={`${logoUrl}?v=8`} />
      </head>
